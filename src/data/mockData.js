...
export const REVISION_LOG_SEED = {
      'SM5718': {
        'EVT1': {
          ...
          historyBlocks: [],
          issues: [
            { id: 1001, entryMode: 'new', ipBlock: 'Buck', issueNum: 'ISSUE#1', types: ['Initial'], severity: 'Major', phenomenon: '리플과다', rootCause: '회로설계오류', disposition: 'Revision', justification: '', modPlan: '타이밍 최적화', customerAlignment: 'Aligned', customerReportType: 'Sanitized', sanitizedStory: 'ㅇㅇㅇㅇㅇ', customerFacingAttachments: 'ㅇㅇㅇㅇㅇㅇㅇㄹㄴㅁㄷㄹㅇ', customerAlignmentDetails: 'ㄹㄷㄹㄷㅈㄷㄹㅇㄹㅇ', attachments: '', assignee: '홍길동', origin: '', escapeReason: '', sideEffectSource: '' },
            { id: 1002, entryMode: 'new', ipBlock: 'Buck', issueNum: 'ISSUE#2', types: ['Customer request'], severity: 'Minor', phenomenon: '동작범위 개선', rootCause: '고객요구사항', disposition: 'Revision', justification: 'ㅇㅇㅇㅇ', modPlan: 'ㅇㅇㅇㅇ', customerAlignment: 'Aligned', customerReportType: 'Transparent', sanitizedStory: '', customerFacingAttachments: '', customerAlignmentDetails: '', attachments: '', assignee: '홍길동', origin: '', escapeReason: '', sideEffectSource: '' },
            { id: 1003, entryMode: 'new', ipBlock: 'Buck', issueNum: 'ISSUE#3', types: ['Initial'], severity: 'Marginal', phenomenon: 'ㅇㅇㅇ', rootCause: 'ㄷㄷㄷㄷ', disposition: 'SW Workaround', justification: 'ㅇㅇㅇㅇ', modPlan: '', customerAlignment: 'Aligned', customerReportType: 'Transparent', sanitizedStory: '', customerFacingAttachments: '', customerAlignmentDetails: '', attachments: '', assignee: '홍길동', origin: '', escapeReason: '', sideEffectSource: '' },
            { id: 1004, entryMode: 'new', ipBlock: 'Type-C', issueNum: 'ISSUE#1', types: ['Initial'], severity: 'Fail', phenomenon: 'Water Detection 오동작', rootCause: 'ㅇㅇㅇㅇ', disposition: 'Revision', justification: 'ㅇㅇㅇㅇ', modPlan: 'ㅇㅇㅇㅇ', customerAlignment: 'Aligned', customerReportType: 'Transparent', sanitizedStory: '', customerFacingAttachments: '', customerAlignmentDetails: '', attachments: '', assignee: '홍길동', origin: '', escapeReason: '', sideEffectSource: '' },
          ]
        },
        'EVT2': {
          initialMode: 'eval',
      ...
      faReports: [
        {
          ...
          custStage: 'ES',
          severity: 'S1',
          phenomenon: '저온(-20°C) 환경에서 Buck 출력 리플이 규격(50mV) 대비 2배 초과 발생. 배터리 수명에 직접 영향.',
          rootCause: 'PFM 모드 진입 조건의 히스테리시스 전류 임계값이 낮은 온도에서 오판단. EVT1 설계 당시 온도 계수 미반영.',
        ...
        },
        {
          ...
          custStage: 'ES',
          severity: 'S2',
          phenomenon: '급격한 부하 변동(0→3A) 시 출력 전압 언더슛 발생. 약 80mV 낙폭으로 동작 한계 직전.',
          rootCause: 'Error Amp의 슬루레이트(Slew Rate) 제한으로 인한 과도 응답 지연. 보상 커패시터 값 조정 필요.',
...
export const ipCategoryNameMap = {
      'Power_Management': ['Buck', 'Boost', 'LDO', 'Charge_Pump', 'Battery_Charger', 'Fuel_Gauge', 'PMIC'],
      'Analog_IP': ['ADC', 'DAC', 'PLL', 'Oscillator', 'Bandgap_Reference', 'Comparator', 'OpAmp'],
      'Digital_Logic': ['Microcontroller', 'DSP', 'Standard_Logic', 'Timer', 'Watchdog'],
      'Mixed_Signal': ['SerDes', 'PHY', 'Audio_Codec', 'Video_Codec'],
      'RF_Communication': ['LNA', 'Mixer', 'Power_Amplifier', 'RF_PLL', 'Transceiver'],
      'Interface_Protocol': ['Type-C', 'USB', 'PCIe', 'I2C', 'SPI', 'UART', 'MIPI'],
      'Memory': ['SRAM', 'ROM', 'Flash', 'MRAM', 'OTP'],
      'Sensors': ['Temp_Sensor', 'Current_Sensor', 'Voltage_Monitor', 'Hall_Sensor']
    };
